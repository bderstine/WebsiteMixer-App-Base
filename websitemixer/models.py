...
class User(db.Model):
    ...
    pw_reset = db.Column('pw_reset', db.Boolean(), default=False)
    pw_confirm_id = db.Column('pw_confirm_id', db.String(36))
    pw_confirm_ts = db.Column('pw_confirm_ts', db.Integer)
