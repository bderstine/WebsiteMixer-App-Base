...
class User(db.Model):
    ...
    def get(kls, username):
        ...
        :type email: str
        :returns: User() object of the corresponding user, if found,
                  otherwise None.
    ...
    def check_password(self, password):
        ...
        :param password: User's password.
        :type password: str
        :returns: True if supplied password matches instance password,
                  False if not.
        :rtype: bool
        """
...
class Post(db.Model):
    ...
    date = db.Column('date', db.DateTime, default=datetime.utcnow(),
                     index=True)
    modified = db.Column('modified', db.DateTime, default=datetime.utcnow(),
                         index=True)
    ...
    def get(kls, id):
        ...
        :param id: Post ID.
        :type id: str or int
        :returns: Page() object of the corresponding ID, if found,
                  otherwise None.
        :rtype: instance or None
        """
...
class Comment(db.Model):
    ...
    page_id = db.Column('page_id', db.Integer, db.ForeignKey('page.id'),
                        nullable=True, index=True)
    ...
    def __repr__(self):
        return_string = "<Comment post_id={0}, author={1}, title={2}>"
        return return_string.format(self.post_id, self.author, self.title)
    ...
    def get(kls, id):
        ...
        :param id: Comment ID.
        :type id: str or int
        :returns: Comment() object of the corresponding ID, if found,
                  otherwise None.
        :rtype: instance or None
        """
        return kls.query.filter(kls.id == id.lower()).first()
...
class Page(db.Model):
    ...
    def get(kls, id):
        ...
        :param id: Page ID.
        :type id: str or int
        :returns: Page() object of the corresponding ID, if found, otherwise
                  None.
        :rtype: instance or None
        """
        return kls.query.filter(kls.id == id.lower()).first()
...
class Preference(db.Model):
    ...
    def __repr__(self):
        return_string = "<Preference user_id={0}, option={1}, value={2}>"
        return return_string.format(self.user_id, self.option, self.value)
